...
export default function Terms() {
  ...
  return (
    <div className="p-6 md:p-8 min-h-screen" style={{ backgroundColor: darkMode ? '#0f0f0f' : '#f9fafb' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold mb-2" style={{ color: darkMode ? '#ffffff' : '#111827' }}>
          Terms & Privacy Policy
        </h1>
        <p className="mb-8" style={{ color: darkMode ? '#9ca3af' : '#6b7280' }}>
          Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
        </p>

        {/* Important Disclaimer */}
        <Card className="mb-6" style={{ 
          backgroundColor: darkMode ? '#1f2937' : '#fff3cd',
          border: `1px solid ${darkMode ? '#f59e0b' : '#ffc107'}`
        }}>
          <CardHeader>
            <CardTitle className="flex items-center gap-2" style={{ color: darkMode ? '#fbbf24' : '#856404' }}>
              <AlertTriangle className="w-5 h-5" />
              Important Financial Disclaimer
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="mb-3" style={{ color: darkMode ? '#fde68a' : '#856404' }}>
              <strong>Ledgera AI is NOT a substitute for professional financial advice.</strong>
            </p>
            <p className="mb-2" style={{ color: darkMode ? '#fde68a' : '#856404' }}>
            ...
            <ul className="list-disc list-inside mb-2 space-y-1" style={{ color: darkMode ? '#fde68a' : '#856404' }}>
            ...
            <p style={{ color: darkMode ? '#fde68a' : '#856404' }}>
        ...
        {/* Privacy Policy */}
        <Card className="mb-6" style={{ backgroundColor: darkMode ? '#1f2937' : '#ffffff', border: `1px solid ${darkMode ? '#374151' : '#e5e7eb'}` }}>
          <CardHeader>
            <CardTitle className="flex items-center gap-2" style={{ color: darkMode ? '#ffffff' : '#111827' }}>
          ...
          <CardContent className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold mb-2" style={{ color: darkMode ? '#ffffff' : '#111827' }}>
                1. Your Data is Private and Secure
              </h3>
              <p className="mb-2" style={{ color: darkMode ? '#d1d5db' : '#374151' }}>
              ...
              <ul className="list-disc list-inside space-y-1 mb-2" style={{ color: darkMode ? '#d1d5db' : '#374151' }}>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1" style={{ color: darkMode ? '#d1d5db' : '#374151' }}>
        ...
        <Card className="mb-6" style={{ backgroundColor: darkMode ? '#1f2937' : '#ffffff', border: `1px solid ${darkMode ? '#374151' : '#e5e7eb'}` }}>
          <CardContent className="pt-6 space-y-6">
            ...
            <hr style={{ borderColor: darkMode ? '#374151' : '#e5e7eb' }} />

            <div>
              <h3 className="text-lg font-semibold mb-3" style={{ color: darkMode ? '#ffffff' : '#111827' }}>
                © Copyright & Intellectual Property
              </h3>
              <p className="font-semibold mb-2" style={{ color: darkMode ? '#ffffff' : '#111827' }}>
                © {new Date().getFullYear()} Ledgera AI. All rights reserved.
              </p>
              <p className="mb-3" style={{ color: darkMode ? '#d1d5db' : '#374151' }}>
            ...
            <div>
              <h3 className="font-semibold mb-2" style={{ color: darkMode ? '#ffffff' : '#111827' }}>
                Your Content
              </h3>
              <p style={{ color: darkMode ? '#d1d5db' : '#374151' }}>
        ...
        {/* Footer */}
        <div className="text-center py-6" style={{ color: darkMode ? '#9ca3af' : '#6b7280' }}>
          <p className="text-sm">
