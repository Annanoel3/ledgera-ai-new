  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: darkMode ? '#0f0f0f' : '#ffffff', minHeight: '100vh' }}>
        ...
        {isChat &&
        <div className="mobile-bottom-nav fixed bottom-0 left-0 right-0 md:hidden z-50 flex items-center justify-around border-t" style={{
          backgroundColor: darkMode ? '#1a1a1a' : '#ffffff',
          borderColor: darkMode ? '#374151' : '#e5e7eb'
        }}>
            <Link to={createPageUrl("Dashboard")} className="flex flex-col items-center gap-1 my-6">
